...
protected:
	...
	*/
	...
	/** Set bAiming to true or flase with button press */
...
private:
	...
	/** Base turn rate, in deg/sec. Other scailing may affcet final turn rate */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
	float BaseTurnRate;

	/** Base look up/down rate, in deg/sec. Other scailing may affcet final look up/down rate */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = FOV, meta = (AllowPrivateAccess = "true"))
	...
	/** Combat state, can only fire or reloading if Unoccupied */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
