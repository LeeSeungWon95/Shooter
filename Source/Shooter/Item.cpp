...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		// Elasped time since we started ItemInterpTimer
		const float ElaspedTime = GetWorldTimerManager().GetTimerElapsed(ItemInterpTimer);
		// Get curve value corresponding to ElaspedTime
...
void AItem::OnConstruction(const FTransform& Transform)
{
	...
	UDataTable* RarityDataTableObject = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, *RarityTablePath));

	if (RarityDataTableObject)
	{
		FItemRarityTable* RarityRow = nullptr;
		switch (ItemRarity)
		{
			case EItemRarity::EIR_Damaged:
			RarityRow = RarityDataTableObject->FindRow<FItemRarityTable>(FName("Damaged"), TEXT(""));
			break;
			case EItemRarity::EIR_Common:
				RarityRow = RarityDataTableObject->FindRow<FItemRarityTable>(FName("Common"), TEXT(""));
			break;
			case EItemRarity::EIR_Uncommon:
				RarityRow = RarityDataTableObject->FindRow<FItemRarityTable>(FName("Uncommon"), TEXT(""));
			break;
			case EItemRarity::EIR_Rare:
				RarityRow = RarityDataTableObject->FindRow<FItemRarityTable>(FName("Rare"), TEXT(""));
			break;
			case EItemRarity::EIR_Legendary:
				RarityRow = RarityDataTableObject->FindRow<FItemRarityTable>(FName("Legendary"), TEXT(""));
			break;
		}
